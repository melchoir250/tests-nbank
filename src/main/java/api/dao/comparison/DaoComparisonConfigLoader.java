...
public final class DaoComparisonConfigLoader {
  ...
  public DaoComparisonConfigLoader(String configFile) {
    try (InputStream input = getClass().getClassLoader().getResourceAsStream(configFile)) {
      ...
      throw new RuntimeException("Failed to load DAO comparison config", error);
    }
  }
  ...
  public static final class DaoComparisonRule {
